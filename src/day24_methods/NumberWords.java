...
public class NumberWords {
    ...
    // 8 -- > eight
                    ...
                    //string debajo tiene que coincidir con este.
    public static String numberAsWord (int num) {//en esta llame a int porque debo colocar el numero, pero el retorno es en String
        String result = "";
...
//        }
        ...
        return result;//tiene que coincidir con el return.
    }
}