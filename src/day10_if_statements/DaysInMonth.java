...
public class DaysInMonth {
    public static void main(String[] args) {
        ...
        System.out.println("Write the number month");
        ...
        if (has31Days) {
            System.out.println("This month has 31 days");
        } else if(has30Days){System.out.println("This month has 30 days");
        } else if (has28Days){System.out.println("This month has 28 days");
        }else {
            System.out.println("The number you gave is not in the range of 1 and 2");
