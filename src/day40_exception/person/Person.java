...
//PARA ASIGNARLES UN VALOR ASI SEA UNAS VARIABLES DE INSTANCIA LLAMO A LOS GETTERS(IMPRIME) Y SETT(LOS ASIGNA)
    ...
    public void setName(String name) throws Exception {//solo la lanzamos, en algun momento se debe manejar.
...
//CON ESTAS CONDICIONES YO DEFINO QUE ES LO QUE SERA UNA EXCEPTION.
            ...
            //este finaliza aqui y me envia hacia cathc de Using person, y alla tengo para imprimir porque es un metodo void e.printStackTrace()
    ...
    public void setAge(int age) {//se crea con if porque es una condicion, no siempre ha de ser buena o MALA.**//aqui no estoy manejando nada de compilacion pero solo porque a el no le dio la gana.
...
//        Aqui no tengo que declarar el throws, porque quiero manejar el Runtime exception, y esta clase nunca se va a correr, porque el objeto throw new, es la misma exception.
        if (age < 0 || age > 120) {//creo estos dos porque son los erroneos, entonces cuando este fuera de ese valor arroje esto.
            throw new IllegalArgumentException("Age must be between 0 and 120");//le pongo lo que me de la gana de excepcion sin ningun problema.//solo para arrojar la excepcion.
        }
