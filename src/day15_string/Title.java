...
public class Title {
    public static void main(String[] args) {
        ...
        //Tom Jerry, Dr.
    if(name.startsWith("mr.")|| name.startsWith("mister")||name.startsWith("dr")){
        System.out.println("Hello Sir");}else if (name.startsWith("ms")|| name.startsWith("miss")|| name.startsWith("madam")){
        System.out.println("Hello Ma'am");} else if(name.startsWith("dr.")){
        System.out.println("Hello Doctor");} else if(name.endsWith("sr.")){
        System.out.println("Nice to meet you Senior");} else if(name.endsWith("jr")){
